function sdt = casssdttext(x, y, depth, rangeUnit, depthUnit)
%CASSBDTTEXT Create a CASS surface depth table
%
% sdt = casssdttext(x, y, depth, rangeUnit, depthUnit)
%
% This function generates a CASS surface depth table.
%
% Input variables:
%
...
% Output variables:
%
%   sdt:        n x 1 cell array of strings holding text of a properly
%               formattted CASS surface depth table
%
% Example:
%
% [x,y] = meshgrid(1:2);
% z = 10*rand(size(x));
% a = casssdttext(x,y,z,'km','m')
% 
% a = 
% 
%     'SURFACE DEPTH TABLE'
...
sdtBody = cellfun(formatText, num2cell(xyz,2), 'UniformOutput', false);
sdtBody = sdtBody(:);

sdt = [sdtHeader; sdtBody; {'EOT'}];
